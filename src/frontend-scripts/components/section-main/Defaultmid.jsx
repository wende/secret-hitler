...
const Defaultmid = ({ version, readPatchNotes, quickDefault, userInfo }) => (
	<section className="defaultmid">
		...
		<img src="/images/lizard29.png" alt="Secret Wende log" width="400" height="400" />
		<p>
			...
			<span>
				...
				|{' '}
				<a rel="noopener noreferrer" target="_blank" style={{ color: 'lightgreen' }} href="https://github.com/cozuya/secret-Wende/wiki">
					wiki page
				</a>{' '}
				|{' '}
